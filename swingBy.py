...
# Start aus einer NASA-Arbeit kopiert
start = "2021-11-22"
AU = 149597870700
...
# Bezeichung und Punkt wird für jeden Himmelskörper initialisiert...
...
# ... und für jeden Zeitschritt angezeigt
def update(i):
